...
with DAG(
    ...
    run_this = PapermillOperator(
        ...
        input_nb="https://github.com/apache/airflow/blob/master/airflow/providers/papermill/example_dags/input_notebook.ipynb",
...
with DAG(
    ...
    check_output = PythonOperator(task_id='check_out', python_callable=check_notebook)
